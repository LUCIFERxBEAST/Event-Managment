...
<div class="container my-5">
    ...
    <div class="card shadow-lg border-0 overflow-hidden">
        <div class="card-header bg-dark text-white p-4">
            <h1 class="fw-bold mb-0"><?php echo htmlspecialchars($event['title']); ?></h1>
            <p class="mb-0 text-white-50">📍 <?php echo htmlspecialchars($event['venue']); ?></p>
        </div>
        ...
        <div class="card-body p-4">
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <p class="fs-5"><?php echo date('D, d M Y • h:i A', strtotime($event['event_start'])); ?></p>
                </div>
                <div class="col-md-6">
                    <h5 class="fw-bold text-danger">End Time</h5>
                    <p class="fs-5"><?php echo date('D, d M Y • h:i A', strtotime($event['event_end'])); ?></p>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                foreach($tags as $tag) {
                    if(trim($tag) != '') echo "<span class='badge bg-secondary me-1'>$tag</span>";
                }
                ?>
            </div>
            ...
            <div class="d-grid gap-2">
                ...
                <?php elseif ($is_registered): ?>
                    ...
                    <a href="ticket.php?hash=<?php echo $ticket_hash; ?>" class="btn btn-success btn-lg fw-bold">View My Ticket</a>
