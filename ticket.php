...
<head>
    ...
    <style>
        ...
        .pin-box:hover { background: #ddd; }
        .hidden-pin span { filter: blur(5px); }
        
        /* Punch Hole Effect */
        .punch-hole {
            width: 40px; height: 40px; background: #1a1a2e;
            border-radius: 50%; position: absolute; top: 180px;
        }
        .punch-left { left: -20px; }
        .punch-right { right: -20px; }
        ...
        .status-registered { background: white; color: #0d6efd; }
        .status-present { background: #198754; color: white; border: 2px solid white;}
    </style>
</head>
<body>
...
<div class="ticket-card">
    <div class="ticket-header">
        <span class="status-badge <?php echo ($ticket['status']=='Present') ? 'status-present' : 'status-registered'; ?>">
    ...
    <div class="ticket-body">
        <h4 class="fw-bold mb-1"><?php echo htmlspecialchars($ticket['title']); ?></h4>
        <p class="text-muted small mb-4">📍 <?php echo htmlspecialchars($ticket['venue']); ?></p>
        ...
        <div class="row text-start">
            <div class="col-6">
                ...
                <strong><?php echo htmlspecialchars($ticket['participant_name']); ?></strong>
            </div>
            <div class="col-6 text-end">
                <small class="text-muted">DATE</small><br>
                <strong><?php echo date('M d', strtotime($ticket['event_start'])); ?></strong>
            </div>
        </div>
        ...
        <div class="mt-4">
            ...
            <div class="pin-box hidden-pin" onclick="this.classList.toggle('hidden-pin')">
                <span><?php echo $ticket['access_pin']; ?></span>
            </div>
        </div>
    </div>
