...
<div class="text-center">
    ...
    <p class="text-muted">We sent a 6-digit code to <strong><?php echo htmlspecialchars($userData['email']); ?></strong></p>
    ...
    <form method="POST" class="d-inline-block text-start" style="max-width: 300px;">
        <div class="mb-3">
            ...
            <input type="number" name="otp" class="form-control text-center text-primary fw-bold" style="font-size: 24px; letter-spacing: 5px;" placeholder="000000" required>
        </div>
