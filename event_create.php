                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" name="title" id="eventTitle" class="form-control" placeholder="e.g. AI Revolution 2026" required>
                            <button type="button" class="btn btn-warning fw-bold" onclick="magicFill()">✨ Auto-Fill Details</button>
                        </div>
                        <small class="text-muted">Type a title and click 'Auto-Fill' to let AI write the rest!</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="venue" id="venue" class="form-control" placeholder="e.g. Main Auditorium" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="btn-group-toggle" data-toggle="buttons">
                            ...
                            <label class="btn btn-outline-primary btn-sm rounded-pill m-1" for="t4">Blockchain</label>
                    ...
                    <button type="submit" name="create_event" class="btn btn-success w-100 py-2 fw-bold">🚀 Launch Event</button>
                </form>
