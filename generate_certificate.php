...
<html lang="en">
<head>
    <title>Certificate - <?php echo htmlspecialchars($participant_name); ?></title>
    <link href="https://fonts.googleapis.com/css2?family=Pinyon+Script&family=Cinzel:wght@400;700&family=Open+Sans:wght@400;600&display=swap" rel="stylesheet">
    <style>
        body {
        ...
        button:hover { background: #b3922b; }

        @media print {
            .no-print { display: none; }
            body { background: white; margin: 0; }
            .cert-container { box-shadow: none; border: 5px solid #2c3e50; width: 100%; height: 100vh; }
        }
    </style>
</head>
<body>
    ...
    <div class="cert-container">
        <div class="border-inner">
            ...
            <div class="name"><?php echo htmlspecialchars($participant_name); ?></div>
            
            <div class="description">
                For active participation and excellence demonstrated in the<br>
                <span class="event-name"><?php echo htmlspecialchars($event_name); ?></span>
            </div>
